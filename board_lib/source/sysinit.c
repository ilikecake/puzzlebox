...
/* Stuff added for our board: set up UART0 */
STATIC const PINMUX_GRP_T pinmuxing[] = {
	...
	/* ENET */
	{0x1, 0,  IOCON_MODE_INACT,                   IOCON_FUNC0},	/* ENET_TXD0 */
	{0x1, 1,  IOCON_MODE_INACT,                   IOCON_FUNC0},	/* ENET_TXD1 */
	{0x1, 4,  IOCON_MODE_INACT,                   IOCON_FUNC0},	/* ENET_TX_EN */
...
STATIC void SystemSetupClocking(void)
{
	...
	Chip_Clock_SetupPLL(SYSCTL_MAIN_PLL, 9, 0);/* Multiply by 20, Divide by 1 */
	...
	Chip_Clock_SetCPUClockDiv(4);	/* pre-minus 1 */
